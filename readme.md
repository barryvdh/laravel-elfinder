...
Important: To use `disk` Array, your `root` array in `elfinder.php` has to be empty. Otherwise your disk configuration will be ignored. [See Controller](https://github.com/barryvdh/laravel-elfinder/blob/master/src/ElfinderController.php#L77)
